...
namespace vk {
    namespace su {
        ...
        vk::Pipeline createGraphicsPipeline(vk::Device const& device,
            ...
            std::array<vk::PipelineShaderStageCreateInfo, 2> pipelineShaderStageCreateInfos = {
                    vk::PipelineShaderStageCreateInfo(
                            vk::PipelineShaderStageCreateFlags(), vk::ShaderStageFlagBits::eVertex, vertexShaderData.first, "main",
                            vertexShaderData.second),
                    vk::PipelineShaderStageCreateInfo(
                            vk::PipelineShaderStageCreateFlags(), vk::ShaderStageFlagBits::eFragment, fragmentShaderData.first, "main",
...
#endif
        {
            ...
            deviceMemory = vk::su::allocateDeviceMemory(device, physicalDevice.getMemoryProperties(), device.getBufferMemoryRequirements(buffer),
                                                        propertyFlags);
        ...
        SurfaceData::SurfaceData(SurfaceData&& other) noexcept
                : extent(other.extent),
                  window(std::move(other.window)),
                  surface(other.surface) {}

        SurfaceData& SurfaceData::operator=(SurfaceData&& other) noexcept {
